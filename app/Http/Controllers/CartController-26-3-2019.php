...
class CartController extends Controller
{
    ...
    public function placeOrder(Request $request) {
        ...
        if ($request->full_name == "" || $request->email == "" || $request->contact_no == "" || $request->address1 == "" || $request->address2 == "" || $request->city == "" || $request->post_code == "" || $request->country == "" || $request->state == "") {
	...
	public function updateTransactionDetails(){
       ...
       /* $order_id = $_POST['custom'];
		...
		//###################### Booking mail goes to USER#################
		$body1='<table width="100%" style="border:1px solid #EEE; background-color:#FFF; font-size:14px;" cellpadding="0" cellspacing="0">
<tbody>
  <tr>
  ...
  <tr>
    <td style="background-color:#ffffff; padding:10px;">
      ...
      <tr>
      <td height="30" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Date :<span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.date("jS M, Y",strtotime($order_dtls->created_at)).'</span></td>
       <td><span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->full_name.'</span></td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Contact No. : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->contact_no.'</span></td>
      </tr>
      
      <tr>
      <td height="30" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Order ID : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->id.'</span></td>
      <td><span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->address1.' , '.$order_dtls->address2.'</span></td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Email : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->email.'</span>
      </td>
      </tr>
      
      <tr>
      <td height="30" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Transaction ID : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->transaction_id.'</span></td>
       <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">City : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->city.'</span>
      
      &nbsp; &nbsp; Post Code : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->post_code.'</span></td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      </tr>
      
      <tr>
      <td height="30" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Item Total  :   <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">&dollar;  '.number_format($order_dtls->total_amount,'2','.','').'</span></td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">State : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->state.'</span>
      
      &nbsp; &nbsp; Country : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$order_dtls->country.'</span>
      </td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      </tr>
      ...
      <tr>
      <td height="30" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Shipping Price : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">&dollar;  '.number_format($order_dtls->shipping_amount,'2','.','').'</span></td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      </tr>
      <tr>
      <td height="30" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">Grand Total : <span style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">&dollar;  '.number_format($order_dtls->grand_total,'2','.','').'</span></td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      </tr>
      <tr>
      <td height="30" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      <td>&nbsp;</td>
      <td style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color: #000000; font-weight: bold;">&nbsp;</td>
      </tr>
      ...
      <div style="font-size:14px; line-height:22px; padding:0px 0px 30px 0px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0px solid #707A54;">
        <tr style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px; color:#000000; font-weight: bold;" bgcolor="#ffffff">
        <td width="32%" height="30" style="padding-left:10px;">Item Details</td>
        <td width="34%">&nbsp;</td>
        <td width="34%">&nbsp;</td>
        </tr>
        <tr>
        ...
        $body1 =$body1.'<tr style=""><td valign="top" style="padding-left:10px;">
        
        <img src="'.$site_url."public/product-photo/".$item_det->productPrice->product->prd_photo.'"  style="height:80px; width:80px; margin:10px; padding:10px; border:1px solid #707A54;"/>
          ...
          <td style="padding-left:20px; padding-top:10px; padding-bottom:10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal; line-height:20px;" valign="top">';
		  
		 $body1 =$body1.'Product Name :'.$item_det->productPrice->product->prd_name."<br>";
		 
		  if($item_det->productPrice->size != null){
			  
         $body1 =$body1.$item_det->productPrice->size->size."<br>";
    ...
    top: 5px; background:'.$item_det->productPrice->color->color_code.'"></span>';
		  ...
		  $body1 =$body1.'</td>
        <td style="padding-left:20px; padding-top:10px; padding-bottom:10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal; line-height:20px;" valign="top">
        Product Name : '.$item_det->productPrice->product->prd_name.'<br>
        Unit Price : &nbsp; &dollar; '.number_format($item_det -> unit_price,2,'.','').'<br>
        Qty : &nbsp; '.$item_det -> qty.' <br>
        Total Price : &nbsp; &dollar; '.number_format($item_det -> total_price,2,'.','').'
        </td>
        </tr>
        
        <tr>
        <td height="1" colspan="3" bgcolor="#707A54"></td>
        </tr>';
      ...
      $body1 =$body1.'<div style="padding:20px 0px 20px 0px; font-size:13px; line-height:22px;">
      <strong>Thank you,</strong><br />
      <span style="color:#000;">'.$admin_name.'</span><br />
