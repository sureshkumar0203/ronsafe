      ...
      <div class="col-12 stretch-card">
        <div class="card">
          <div class="card-body my-ac">
            ...
            <div class="form-group row"  id="disp_pp">
              <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Product Price<span class="text-danger">*</span></label>
              <div class="col-sm-5">
                {!! Form::text('product_price',null,array('id' => 'product_price','required', 'class'=>'form-control','placeholder'=>'','onKeyUp' => 'validatePrice(this);')) !!}
                
                <div class="error-hgt">@if ($errors->has('product_price'))<p class="text-warning">{{ $errors->first('product_price') }}</p>@endif</div> 
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-5">
                <input type="radio" name="cs" id="cs" value="0" checked onclick="dispSizeColor('0')"/> No
                <input type="radio" name="cs" id="cs" value="1" onclick="dispSizeColor('1')"/> Yes
                
                <div class="error-hgt"></div> 
              </div>
            </div>
            
            <div class="form-group col-md-8" id="disp_sc" style="display:none">
