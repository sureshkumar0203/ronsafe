       ...
       <div class="col-md-12 col-sm-12">
        ...
        <i class="fa fa-check-circle" style="font-size:48px;color:green;"></i><br>
         ...
         <strong class="green-text">Thank You.</strong>
           <h3 class="line-hgt33">Your transaction has been completed successfully.<br>
            We will contact to you very soon.</h3>
            
            @if(Session::get('user_id'))
               <a href="user-dashboard">Click here </a> to view your Booking.
            @endif
        </div>
      </div>
    </div>
